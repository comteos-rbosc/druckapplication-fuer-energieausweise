...
#End Region
'--------------------------------------------------
Public Class Klasse_Energieausweis_NWB_2023
    '--------------------------------------------------
#Region "New"
    '--------------------------------------------------
    ''' <summary>
...
#Region "Energieausweis erstellen"
    '--------------------------------------------------
    ''' <summary>
    ''' Hier wird der gesamte Ablauf für die Erstellung der Energieausweises abgearbeitet - Nichtwohnbau - GEG 2023
    ''' </summary>
...
#Region "Variablen"
            '-------------------------------------------------------
            Dim Datum_Energiegesetz As String = "20.07.2022"
            '-------------------------------------------------------
...
#Region "Seite 1"
            ...
            '-------------------------------------------------------
            Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Seite_1.png")
            ...
            With Variable_XML_Import
                ...
                '--------------------------------------------------
                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Lueftungsart_Fensterlueftung.Wert, 1519, 1544, 2373, 2403)
                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Lueftungsart_Schachtlueftung.Wert, 1519, 1544, 2450, 2480)
                ...
                '-------------------------------------------------------            
                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Kuehlungsart_passive_Kuehlung.Wert, 1519, 1544, 2574, 2605)
                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Kuehlungsart_gelieferte_Kaelte.Wert, 1519, 1544, 2652, 2683)
                ...
                Select Case .Energieausweis_Daten.Ausstellungsanlass.Wert
                    Case "Neubau"
                        Image_Auswahl_schreiben(Grafik_Seite, True, 1519, 1544, 2884, 2915)
                        Image_Auswahl_schreiben(Grafik_Seite, False, 2441, 2472, 2884, 2915)
                        Image_Auswahl_schreiben(Grafik_Seite, False, 1519, 1544, 2962, 2993)
                    ...
                    Case "Modernisierung-Erweiterung"
                        Image_Auswahl_schreiben(Grafik_Seite, False, 1519, 1544, 2884, 2915)
                    ...
                    Case "Vermietung-Verkauf"
                        Image_Auswahl_schreiben(Grafik_Seite, False, 1519, 1544, 2884, 2915)
                        Image_Auswahl_schreiben(Grafik_Seite, False, 2441, 2472, 2884, 2915)
                        Image_Auswahl_schreiben(Grafik_Seite, True, 1519, 1544, 2962, 2993)
                        Image_Auswahl_schreiben(Grafik_Seite, False, 3278, 3309, 2962, 2993)
                        Image_Auswahl_schreiben(Grafik_Seite, False, 3278, 3309, 2884, 2915)
                    Case "Sonstiges"
                        Image_Auswahl_schreiben(Grafik_Seite, False, 1519, 1544, 2884, 2915)
...
#Region "Seite 2"
            ...
            Grafik_Seite.Clear(Color.White)
            '-------------------------------------------------------
            Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Seite_2.png")
            Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
            '-------------------------------------------------------
                    ...
                    Case "Energiebedarfsausweis"
                        ...
                        Select Case .Berechnungsverfahren
                            Case "Bedarfsberechnung-18599"
                                ...
                                '-------------------------------------------------------
                                Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Endenergiebedarf_Waerme_NGF.Wert, 1, "", 3019, 3660, 3377, 3493, Font_Schriftgroesse_60, Font_Druckfarbe)
                                Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Endenergiebedarf_Strom_NGF.Wert, 1, "", 3019, 3660, 3497, 3622, Font_Schriftgroesse_60, Font_Druckfarbe)
                                '-------------------------------------------------------
                                ...
                                '-------------------------------------------------------
                                Zeilenzahl = 3
                                Zeilenhoehe = (3251 - 2955) / 3
                                '-------------------------------------------------------
                                If .Energiebedarf_Anzahl < 3 Then
                                ...
                                If .Energiebedarf_Anzahl > 3 Then
                                    '-------------------------------------------------------
                                    Image_Auswahl_schreiben(Grafik_Seite, True, 300, 331, 3281, 3312)
                                    '-------------------------------------------------------
                                End If
                                '-------------------------------------------------------
                                'Tabelle Zonen -----------------------------------------
                                ...
                                '-------------------------------------------------------
                                Zeilenzahl = 8
                                Zeilenhoehe = (4548 - 3949) / 8
                                '-------------------------------------------------------
                                If .Zonen_Anzahl < 8 Then
                                    Zeilenzahl = .Zonen_Anzahl
                                End If
                                '-------------------------------------------------------
                                For Anzahl_Zeilen = 1 To Zeilenzahl
                                    '-------------------------------------------------------
                                    Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, Anzahl_Zeilen, 0, "", 2189, 2299, 3949 + (Zeilenhoehe * (Anzahl_Zeilen - 1)), 3949 + (Zeilenhoehe * Anzahl_Zeilen), Font_Schriftgroesse_40, Font_Druckfarbe)
                                    '-------------------------------------------------------
                                    Image_Text_schreiben(Grafik_Seite, Ausrichtung.EinzeiligLinks, .Energieausweis_Daten.Nichtwohngebaeude.Zone(Anzahl_Zeilen).Zonenbezeichnung.Wert, 2303, 3318, 3949 + (Zeilenhoehe * (Anzahl_Zeilen - 1)), 3949 + (Zeilenhoehe * Anzahl_Zeilen), Font_Schriftgroesse_40, Font_Druckfarbe)
                                    '--------------------------------------------------
                                    If .Energieausweis_Daten.Nichtwohngebaeude.Zone(Anzahl_Zeilen).Nettogrundflaeche_Zone.Wert <> 0 Then
                                        Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, .Energieausweis_Daten.Nichtwohngebaeude.Zone(Anzahl_Zeilen).Nettogrundflaeche_Zone.Wert, 1, "", 3322, 3669, 3949 + (Zeilenhoehe * (Anzahl_Zeilen - 1)), 3949 + (Zeilenhoehe * Anzahl_Zeilen), Font_Schriftgroesse_40, Font_Druckfarbe)
                                    End If
                                    '--------------------------------------------------
                                    If .Energieausweis_Daten.Nichtwohngebaeude.Zone(Anzahl_Zeilen).Nettogrundflaeche_Zone.Wert <> 0 Then
                                        Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, (.Energieausweis_Daten.Nichtwohngebaeude.Zone(Anzahl_Zeilen).Nettogrundflaeche_Zone.Wert / .Energieausweis_Daten.Nichtwohngebaeude.Nettogrundflaeche.Wert * 100), 2, "", 3679, 4032, 3949 + (Zeilenhoehe * (Anzahl_Zeilen - 1)), 3949 + (Zeilenhoehe * Anzahl_Zeilen), Font_Schriftgroesse_40, Font_Druckfarbe)
                                    End If
                                    '--------------------------------------------------
                                Next
                                '-------------------------------------------------------
                                For Anzahl_Zeilen = 1 To 8
                                    '-------------------------------------------------------
                                    Image_Linie(Grafik_Seite, 2189, 4030, 3949 + (Zeilenhoehe * Anzahl_Zeilen), 3949 + (Zeilenhoehe * Anzahl_Zeilen))
                                    '-------------------------------------------------------
                                Next
                                '-------------------------------------------------------
                                If .Zonen_Anzahl > 8 Then
                                    '-------------------------------------------------------
                                    Image_Auswahl_schreiben(Grafik_Seite, True, 2257, 2288, 4589, 4615)
                                    '-------------------------------------------------------
                                End If
                                '-------------------------------------------------------
                                ...
                                Select Case .Energieausweis_Daten.Ausstellungsanlass.Wert
                                    Case "Neubau"
                                        ...
                                        If .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Art_der_Nutzung_erneuerbaren_Energie_1.Wert <> "" Then
                                            '-------------------------------------------------------
                                            Image_Text_schreiben(Grafik_Seite, Ausrichtung.EinzeiligLinks, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Art_der_Nutzung_erneuerbaren_Energie_1.Wert, 270, 1454, 4216, 4322, Font_Schriftgroesse_40, Font_Druckfarbe)
                                            Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Deckungsanteil_1.Wert, 0, "", 1469, 1677, 4216, 4322, Font_Schriftgroesse_40, Font_Druckfarbe)
                                            Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Anteil_der_Pflichterfuellung_1.Wert, 0, "", 1772, 1978, 4216, 4322, Font_Schriftgroesse_40, Font_Druckfarbe)
                                            '-------------------------------------------------------
                                            Summe_Deckungsanteil += .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Deckungsanteil_1.Wert
                                            Summe_Anteil_Pflichterfuellung += .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Anteil_der_Pflichterfuellung_1.Wert
                                            '-------------------------------------------------------
                                        End If
                                        If .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Art_der_Nutzung_erneuerbaren_Energie_2.Wert <> "" Then
                                            '-------------------------------------------------------
                                            Image_Text_schreiben(Grafik_Seite, Ausrichtung.EinzeiligLinks, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Art_der_Nutzung_erneuerbaren_Energie_2.Wert, 270, 1454, 4330, 4427, Font_Schriftgroesse_40, Font_Druckfarbe)
                                            Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Deckungsanteil_2.Wert, 0, "", 1469, 1677, 4330, 4427, Font_Schriftgroesse_40, Font_Druckfarbe)
                                            Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Anteil_der_Pflichterfuellung_2.Wert, 0, "", 1772, 1978, 4330, 4427, Font_Schriftgroesse_40, Font_Druckfarbe)
                                            '-------------------------------------------------------
                                            Summe_Deckungsanteil += .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Deckungsanteil_2.Wert
                                            Summe_Anteil_Pflichterfuellung += .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Anteil_der_Pflichterfuellung_2.Wert
                                            '-------------------------------------------------------
                                        End If
                                        '-------------------------------------------------------
                                        Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, Summe_Deckungsanteil, 0, "", 1469, 1677, 4436, 4540, Font_Schriftgroesse_40, Font_Druckfarbe)
                                        Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, Summe_Anteil_Pflichterfuellung, 0, "", 1772, 1978, 4436, 4540, Font_Schriftgroesse_40, Font_Druckfarbe)
                                        '-------------------------------------------------------
                                        Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.verschaerft_nach_GEG_45_eingehalten.Wert, 305, 347, 5034, 5076)
                                        If .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.nicht_verschaerft_nach_GEG_34.Wert = False Then
                                            Image_Auswahl_schreiben(Grafik_Seite, True, 305, 347, 5191, 5232)
                                            Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.Mitte_kein_Abschneiden, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Anforderung_nach_GEG_19_unterschritten.Wert, 0, "", 1724, 1834, 5249, 5311, Font_Schriftgroesse_40_Narrow, Font_Druckfarbe)
                                            Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.Mitte_kein_Abschneiden, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.verschaerft_nach_GEG_34.Wert, 0, "", 1422, 1538, 5321, 5381, Font_Schriftgroesse_40_Narrow, Font_Druckfarbe)
                                        Else
                                            Image_Auswahl_schreiben(Grafik_Seite, False, 305, 347, 5191, 5232)
                                        End If
                                        '-------------------------------------------------------
                                ...
                                End Select
                                '-------------------------------------------------------
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Nichtwohngebaeude.Bedarfswerte_NWG.Anforderung_nach_GEG_52_Renovierung_eingehalten.Wert, 305, 347, 5448, 5489)
                                '-------------------------------------------------------
                        End Select
                        '-------------------------------------------------------
                End Select
...
#Region "Seite 3"
            ...
            Grafik_Seite.Clear(Color.White)
            '-------------------------------------------------------
            Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Seite_3.png")
            Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
            '-------------------------------------------------------
            With Variable_XML_Import
                '-------------------------------------------------------
...
#Region "Seite 4"
            ...
            Grafik_Seite.Clear(Color.White)
            '-------------------------------------------------------
            Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Seite_4.png")
            Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
            '-------------------------------------------------------
            With Variable_XML_Import
                '-------------------------------------------------------
...
#Region "Seite 5"
            ...
            Grafik_Seite.Clear(Color.White)
            '-------------------------------------------------------
            Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Seite_5.png")
            Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
            '-------------------------------------------------------
            With Variable_XML_Import
                '-------------------------------------------------------
                            ...
                            For Wert_Schleife = 0 To (Wert_Schleife_Maximum) Step Wert_Schleife_Zeilenzahl
                                ...
                                With Variable_XML_Import
                                    ...
                                    If .Energiebedarf_Anzahl > (Wert_Schleife + Wert_Schleife_Offset) Then
                                        ...
                                        Grafik_Seite.Clear(Color.White)
                                        '-------------------------------------------------------
                                        Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Ueberlauf_Bedarf.png")
                                        Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
                                        '-------------------------------------------------------
                            ...
                            For Wert_Schleife = 0 To (Wert_Schleife_Maximum) Step Wert_Schleife_Zeilenzahl
                                ...
                                With Variable_XML_Import
                                    ...
                                    If .Zonen_Anzahl > (Wert_Schleife + Wert_Schleife_Offset) Then
                                        ...
                                        Grafik_Seite.Clear(Color.White)
                                        '-------------------------------------------------------
                                        Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Ueberlauf_Gebaeudezonen.png")
                                        Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
                                        '-------------------------------------------------------
                                        Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, Seitennummer, 0, "", 3893, 4040, 688, 840, Font_Seitennummer, Font_Druckfarbe)
                                        '-------------------------------------------------------
                    ...
                    For Wert_Schleife = 0 To (Wert_Schleife_Maximum) Step Wert_Schleife_Zeilenzahl
                        ...
                        With Variable_XML_Import
                            ...
                            If .Verbrauchserfassung_Anzahl > (Wert_Schleife + Wert_Schleife_Offset) Then
                                ...
                                Grafik_Seite.Clear(Color.White)
                                '-------------------------------------------------------
                                Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Ueberlauf_Verbrauch.png")
                                Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
                                '-------------------------------------------------------
                                Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, Seitennummer, 0, "", 3893, 4040, 688, 840, Font_Seitennummer, Font_Druckfarbe)
                                '-------------------------------------------------------
                    ...
                    Select Case Variable_XML_Import.Berechnungsverfahren
                        Case "Verbrauchsberechnung"
                            ...
                            If Variable_XML_Import.Gebaeudenutzung_Anzahl > 3 Then
                                ...
                                Grafik_Seite.Clear(Color.White)
                                '-------------------------------------------------------
                                Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Ueberlauf_Gebaeudenutzung.png")
                                Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
                                '-------------------------------------------------------
                                With Variable_XML_Import
                                    '-------------------------------------------------------
            ...
            For Wert_Schleife = 0 To (Wert_Schleife_Maximum) Step Wert_Schleife_Zeilenzahl
                ...
                With Variable_XML_Import
                    ...
                    If .Modernisierungsempfehlung_Anzahl > (Wert_Schleife + Wert_Schleife_Offset) Then
                        ...
                        Grafik_Seite.Clear(Color.White)
                        '-------------------------------------------------------
                        Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_WB_Ueberlauf_Modernisierung.png")
                        Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
                        '-------------------------------------------------------
                        Image_Zahl_schreiben(Grafik_Seite, Ausrichtung.EinzeiligMitte, Seitennummer, 0, "", 3893, 4040, 688, 840, Font_Seitennummer, Font_Druckfarbe)
                        '-------------------------------------------------------
                ...
                Case "Energiebedarfsausweis"
                    ...
                    Select Case Variable_XML_Import.Berechnungsverfahren
                        Case "Bedarfsberechnung-18599"
                            ...
                            Grafik_Seite.Clear(Color.White)
                            '-------------------------------------------------------
                            Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Bedarf_Aushang.png")
                            Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
                            '-------------------------------------------------------
                            With Variable_XML_Import
                                '-------------------------------------------------------
                                ...
                                '--------------------------------------------------
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Lueftungsart_Fensterlueftung.Wert, 1528, 1558, 1939, 1970)
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Lueftungsart_Schachtlueftung.Wert, 1528, 1558, 2010, 2041)
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Lueftungsart_Anlage_m_WRG.Wert, 2695, 2724, 1939, 1970)
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Lueftungsart_Anlage_o_WRG.Wert, 2695, 2724, 2010, 2041)
                                '-------------------------------------------------------            
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Kuehlungsart_passive_Kuehlung.Wert, 1528, 1558, 2103, 2134)
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Kuehlungsart_gelieferte_Kaelte.Wert, 1528, 1558, 2174, 2205)
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Kuehlungsart_Strom.Wert, 2695, 2724, 2103, 2134)
                                Image_Auswahl_schreiben(Grafik_Seite, .Energieausweis_Daten.Kuehlungsart_Waerme.Wert, 2695, 2724, 2174, 2205)
                                '-------------------------------------------------------
...
#Region "Zusatzseite Aushang - Verbrauch"
            ...
            If Variable_Steuerung.Berechnungsart = "Energieverbrauchsausweis" Or Variable_XML_Import.Zusaetzliche_Verbrauchsberechnung = True Then
                ...
                If Variable_XML_Import.Berechnungsverfahren = "Verbrauchsberechnung" Or Variable_XML_Import.Zusaetzliche_Verbrauchsberechnung = True Then
                    ...
                    Grafik_Seite.Clear(Color.White)
                    '-------------------------------------------------------
                    Hintergrundgrafik = Image.FromFile(Variable_Parameter.Arbeitsverzeichnis & "/Image/GEG2023_NWB_Verbrauch_Aushang.png")
                    Grafik_Seite.DrawImage(Hintergrundgrafik, 0, 0, 4200, 5940)
                    '-------------------------------------------------------
                    With Variable_XML_Import
                        '-------------------------------------------------------
